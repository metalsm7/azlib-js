...
class AZSql {
    ...
    getQueryAndParams() {
        var _a, _b, _c, _d;
        if (((_a = this.option) === null || _a === void 0 ? void 0 : _a.sql_type) === AZSql.SQL_TYPE.SQLITE && !this.isPrepared()) {
            return [this._query, []];
        }
        ...
        const keys = (_b = this._parameters) === null || _b === void 0 ? void 0 : _b.getKeys();
        ...
        while (query.search(regex) > -1) {
            ...
            if (key == null)
                continue;
            const val = (_c = this._parameters) === null || _c === void 0 ? void 0 : _c.get(key);
            if (typeof val !== 'undefined' && Array.isArray(val)) {
                ...
                query = query.replace(regex, '$1?$3');
                param.push((_d = this._parameters) === null || _d === void 0 ? void 0 : _d.get(key));
            }
        }
        return [query, param];
    }
        ...
        switch ((_a = this.option) === null || _a === void 0 ? void 0 : _a.sql_type) {
            case AZSql.SQL_TYPE.MYSQL:
                if (typeof this._sql_connection['commit'] === 'undefined') {
                    if (typeof this._sql_connection['of'] === 'undefined') {
